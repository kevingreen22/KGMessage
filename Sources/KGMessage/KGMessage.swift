...
public struct KGMessage {
    ...
    public static func sendEmail(content: KGMessageContent, addresses: [String]) -> some View {
    ...
    public static func sendSMSText(content: KGMessageContent, phoneNumbers: [String]) -> KGComposeSMS {
