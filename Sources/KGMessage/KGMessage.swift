...
public struct KGMessage {
    ...
    static public func sendEmail(content: KGMessageContent, addresses: [String]) -> some View {
    ...
    static public func sendSMSText(content: KGMessageContent, phoneNumbers: [String]) -> KGComposeSMS {
    ...
    static public func callphoneNumber(phoneNumber: String) {
