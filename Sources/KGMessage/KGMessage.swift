...
public struct KGMessage {
    ...
    static func sendEmail(content: KGMessageContent, addresses: [String]) -> some View {
    ...
    static func sendSMSText(content: KGMessageContent, phoneNumbers: [String]) -> KGComposeSMS {
